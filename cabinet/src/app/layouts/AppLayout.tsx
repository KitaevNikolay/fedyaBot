        ...
        <Content className="shell-content">
          <div className="page-head">
            ...
            <Typography.Paragraph className="page-subtitle">
              Авторизация через Telegram временно отключена, поэтому кабинет
              открывается напрямую. Настройки генерации, история действий и
              аналитика доступны из бокового меню.
            </Typography.Paragraph>
          </div>
          <Outlet />
        </Content>
